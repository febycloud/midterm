USE [master]
GO
/****** Object:  Database [BusService]    Script Date: 2017-10-05 10:57:39 AM ******/
...
GO
ALTER DATABASE [BusService] SET DELAYED_DURABILITY = DISABLED 
GO
USE [BusService]
GO
/****** Object:  Table [dbo].[bus]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[busRoute]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[busRoute](
	[busRouteCode] [varchar](50) NOT NULL,
...
GO
/****** Object:  Table [dbo].[busStop]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[busStop](
	...
	[locationHash] [int] NOT NULL,
	[goingDowntown] [bit] NOT NULL,
...
GO
/****** Object:  Table [dbo].[country]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[driver]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[province]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[routeSchedule]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[routeStop]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[trip]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tripStop]    Script Date: 2017-10-05 10:57:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[busRoute] ([busRouteCode], [routeName]) VALUES (N'1', N'Stanley Parks')
...
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (251, N'14', 2113, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (252, NULL, 1224, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (253, N'14', 1458, 3)
...
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (260, N'14', 1000, 8)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (261, N'14', 1000, 4)
...
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (278, N'2', 1465, 55)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (279, N'2', 3138, 555)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (280, N'2', 3138, 555)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (285, NULL, 1224, 2)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (298, N'14', 1000, 0)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (300, N'2', 1224, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (305, N'2', 1073, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (307, N'2', 1224, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (309, N'1', 1000, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (311, NULL, 1030, 2)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (312, N'1', 1224, 3)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (315, N'14', 1224, 1224)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (317, N'14', 1224, 2)
INSERT [dbo].[routeStop] ([routeStopId], [busRouteCode], [busStopNumber], [offsetMinutes]) VALUES (318, N'2', 1224, 3)
SET IDENTITY_INSERT [dbo].[routeStop] OFF
SET IDENTITY_INSERT [dbo].[trip] ON 

INSERT [dbo].[trip] ([tripId], [routeScheduleId], [tripDate], [driverId], [busId], [comments]) VALUES (1, 262, CAST(N'2015-01-23T00:00:00.000' AS DateTime), 1, 9, N'construction diversion')
INSERT [dbo].[trip] ([tripId], [routeScheduleId], [tripDate], [driverId], [busId], [comments]) VALUES (2, 262, CAST(N'2014-12-12T00:00:00.000' AS DateTime), 9, 3, N'stop 1151 added')
INSERT [dbo].[trip] ([tripId], [routeScheduleId], [tripDate], [driverId], [busId], [comments]) VALUES (3, 260, CAST(N'2014-12-12T00:00:00.000' AS DateTime), 9, 3, N'new stop')
INSERT [dbo].[trip] ([tripId], [routeScheduleId], [tripDate], [driverId], [busId], [comments]) VALUES (4, 265, CAST(N'2014-12-12T00:00:00.000' AS DateTime), 9, 3, N'new stop')
SET IDENTITY_INSERT [dbo].[trip] OFF
ALTER TABLE [dbo].[busStop] ADD  CONSTRAINT [DF_busStop_locationHash]  DEFAULT ((0)) FOR [locationHash]
GO
ALTER TABLE [dbo].[province] ADD  CONSTRAINT [DF_province_taxRate]  DEFAULT ((0)) FOR [taxRate]
GO
ALTER TABLE [dbo].[routeSchedule] ADD  CONSTRAINT [DF_routeSchedule_busRouteCode]  DEFAULT ((2)) FOR [busRouteCode]
GO
ALTER TABLE [dbo].[routeStop] ADD  CONSTRAINT [DF_routeStop_busRouteCode]  DEFAULT ((2)) FOR [busRouteCode]
GO
